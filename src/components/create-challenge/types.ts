...
// =============================================================================
// Re-exported from src/lib/workoutCatalog.ts — the single source of truth.
// Kept here for backward compatibility with existing imports.

export {
  WORKOUT_CATALOG as WORKOUT_TYPE_CATALOG,
  type WorkoutCatalogEntry as WorkoutTypeCatalogEntry,
