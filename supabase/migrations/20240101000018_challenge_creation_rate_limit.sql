-- Migration: Challenge creation rate limit
-- Adds a per-user cap on active creator-owned challenges (max 20)
-- to prevent abuse. Recreates create_challenge_with_participant with
-- the rate-limit guard added before the INSERT.
